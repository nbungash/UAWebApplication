...
$(document).ready(function () {
    ...
    $('.vt_save_btn').on('click', function () {
        ...
        $.ajax({
            ...
            data: JSON.stringify(
                {
                    PartyBillId: bill_id_for_view_trips,
                    TripList: tripdata
                }),
...
var bill_id_for_view_trips = 0;

function ViewTripsWindowLoaded(bill_id)
{
    bill_id_for_view_trips = bill_id;
